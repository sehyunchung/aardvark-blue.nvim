--[[
  ...
  Generated on: 2025-08-21T01:18:54.898Z
...
function M.setup(palette, options)
  ...
  -- Syntax highlighting
  highlights.Comment = vim.tbl_extend("force", { fg = "#7a8a9a" }, styles.comments)
  ...
  highlights["@tag.delimiter.tsx"] = { fg = "#7a8a9a" }
  ...
  highlights.StatusLineNC = { fg = "#7a8a9a", bg = "#0a1530" }
  highlights.TabLine = { fg = "#7a8a9a", bg = "#0a1530" }
  ...
  highlights.Folded = { fg = "#7a8a9a", bg = "#1a3050" }
  highlights.FoldColumn = { fg = "#7a8a9a" }
